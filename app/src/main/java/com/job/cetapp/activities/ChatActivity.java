...
import com.job.cetapp.adapters.ChatAdapter;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void updateConversation(String message) {
        DocumentReference documentReference = database.collection(Constants.KEY_COLLECTION_CONVERSATIONS).document(convId);
