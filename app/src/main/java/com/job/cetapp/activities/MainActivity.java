...
import com.job.cetapp.adapters.RecentConversationsAdapter;
import com.job.cetapp.databinding.ActivityMainBinding;
            ...
            for (DocumentChange documentChange : value.getDocumentChanges()) {
                if (documentChange.getType() == DocumentChange.Type.ADDED) {
                    ...
                    if (preferenceManager.getString(Constants.KEY_USER_ID).equals(senderId)) {
                        ...
                        chatMessage.convName = documentChange.getDocument().getString(Constants.KEY_RECEIVER_NAME);
